...
const Fonts: React.FC = () => (
	<Global
		styles={css`
			...
			@font-face {
				font-family: "roobert";
				src: url("/fonts/roobert/roobert-lightitalic-webfont.woff2")
						format("woff2"),
			...
			@font-face {
				...
				src: url("/fonts/reckless/reckless-regular-webfont.woff2")
						format("woff2"),
			...
			@font-face {
				font-family: "Reckless";
				src: url("/fonts/reckless/reckless-regularitalic-webfont.woff2")
						format("woff2"),
					url("/fonts/reckless/reckless-regularitalic-webfont.woff")
						format("woff");
				font-weight: normal;
				font-style: italic;
			}
